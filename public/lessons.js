...
const LESSONS = [
  {
    id: 'l1',
    title: '第 1 关 · 回家键行',
    desc: 'Home Row：a s d f j k l ;（手指的“家”）',
    material: {
      goal: '认识键盘的「回家键」：中间那一排 a s d f 和 j k l ;。平时手指就放在这里，像回家一样，所以叫回家键。把手指放稳，这一关就成功了一半！',
      tip: '左手四指：小指 a、无名指 s、中指 d、食指 f。右手四指：食指 j、中指 k、无名指 l、小指 ; 。打别的键时手指伸出去，打完立刻回到回家键上。',
      example: 'asdf jkl;',
    },
    focus: ['a', 's', 'd', 'f', 'j', 'k', 'l', ';'],
    texts: [
